    ...
    <form method="post" action="atualizar.php">
        ...
        <select name="" id="" value="<?= $curso ?>">
            ...
            <option value="Edificações"
                <?= $curso === "Edificações" ? "selected" : "" ?>
            >Edificações</option>
            <option value="Enfermagem"
                <?= $curso === "Enfermagem" ? "selected" : "" ?>
            >Enfermagem</option>
            <option value="GeoCart"
                <?= $curso === "GeoCart" ? "selected" : "" ?>
            >Geodésia e Cartografia</option>
            <option value="Informática"
                <?= $curso === "Informática" ? "selected" : "" ?>
            >Informática</option>
            <option value="Mecânica"
                <?= $curso === "Mecânica" ? "selected" : "" ?>
            >Mecânica</option>
            <option value="Qualidade"
                <?= $curso === "Qualidade" ? "selected" : "" ?>
            >Qualidade</option>
        </select>
